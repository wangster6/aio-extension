...
<div id="myCustomPopup">
    ...
    <div id="popupContent">Generating response...</div>
</div>
`;
// const popupHTML = document.getElementById("myCustomPopup");
...
document.addEventListener("click", function (event) {
  // Checks if the click was within the popup box then do nothing, otherwise run function
  if (document.querySelector("#myCustomPopup").contains(event.target)) {
  } else {
